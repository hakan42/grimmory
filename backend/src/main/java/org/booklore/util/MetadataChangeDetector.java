...
public class MetadataChangeDetector {
    ...
    private static final List<FieldDescriptor<?>> SIMPLE_FIELDS = List.of(
            ...
            new FieldDescriptor<>("perrypediaId",
                    BookMetadata::getPerrypediaId, BookMetadataEntity::getPerrypediaId,
                    BookMetadata::getPerrypediaIdLocked, BookMetadataEntity::getPerrypediaIdLocked,
                    MetadataClearFlags::isPerrypediaId, true),
